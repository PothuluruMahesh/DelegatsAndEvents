...
{
    public delegate void DelegateMethod6(int i, int j);//best usage of delagate is multicast
    ...
    class Delegate5
    {
        ...
        static void Main(string[] args)
        {
            ...
            DelegateMethod6 dm6 = dm + dm1 + dm2 + dm3 + dm4 +dm5;
            dm6(10,20);
